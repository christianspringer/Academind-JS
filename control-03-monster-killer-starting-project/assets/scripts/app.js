...
try{
  ...
  console.log(error);
  chosenMaxLife = 100;
  alert('Invalid input, default max life set to 100');
} finally{
...
function endRound() {
  ...
  if (currentPlayerHealth <= 0 && hasBonusLife) {
    ...
    alert('You should be dead! The bonus life saved you!');
  }
  ...
  if (currentMonsterHealth <= 0 && currentPlayerHealth > 0) {
    ...
    alert('The monster destroyed you!');
    writeToLog(
      LOG_EVENT_GAME_OVER,
      'MONSTER WON',
      currentMonsterHealth,
    ...
    alert('Both you and the monster are dead.');
    writeToLog(
      LOG_EVENT_GAME_OVER,
      'A DRAW',
      currentMonsterHealth,
